<div dir="rtl">
  ...
  קובץ אשר משותף ליותר מעמוד אחד ימצא בתיקייה כללית בעמוד הראשי של הפרויקט.
  ...
  <h5>את קובץ ה-CSS שלו נוכל למצוא בנתיב: (כאשר קבצי העיצוב של אלמנטים הקשורים בדף זה והובאו מבחוץ נוכל למצוא בשמות שונים באותה התיקייה)</h5>
