...
<p align="center">
 ...
 <h5>
   חלק זה של הפרויקט הוא ה-Backend של המערכת ומשמש לניהול המערכת בכלל, וניהול המשתמשים והמלטלות בפרט. שירות הלקוחות מתבצע באמצעות בקשות בפרוטוקול HTTP הרץ בענן של חברת גוגל תחת שירות פונקציות הענן של Firebase. 
 </h5>
</div>
